#' Y-intercept of an isochron line on a 206Pb/204Pb vs 207Pb/204Pb plot for time (t)
#'
#' This function calculates the y-intercept of an isochron line on a 206Pb/204Pb vs 207Pb/204Pb plot for a given time (t)
#'
...
isochron76yint <- function(t, ..., T1 = 3700, X1 = 11.152, Y1 = 12.998, Mu1 = 9.74, U8U5 = 137.88, L5 = 9.8485 * 10^-10, L8 = 1.55125 * 10^-10, model) {
  if(!missing(model)) {
