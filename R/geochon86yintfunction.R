#' Y-intercept of a geochron line on a 206Pb/204Pb vs 208Pb/204Pb plot for time (t)
#'
#' This function calculates the y-intercept of a geochron line on a 206Pb/204Pb vs 208Pb/204Pb plot for a given time (t)
#'
...
geochron86yint <- function(t, ..., T1 = 3700, X1 = 11.152, Z1 = 31.23, Mu1 = 9.74, W1 = 36.84, L8 = 1.55125 * 10^-10, L2 = 0.49475 * 10^-10, model) {
  if(!missing(model)) {
